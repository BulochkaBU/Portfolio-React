...
const SidePanel = ({colorChangeState}) => {
    ...
    return(
        <aside className="sidepanel">
            <a href="https://t.me/u1011" target="_blank" rel="noreferrer" className="sidepanel__link">
                <svg className="sidepanel__link sidepanel__link_90deg" width="22" height="22" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
