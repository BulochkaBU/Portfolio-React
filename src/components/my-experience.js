...
const MyExperience = () => {
    return(
        ...
        <div className="container">
            <div className="title title_fz19 subheader__subtitle subheader__subtitle_my-experience">Про опыт</div>
            <h2 className="title title_fz36 subheader__title subheader__title_my-experience">Чем я буду полезна</h2>
            <div className="subheader__divider"></div> 
        
            <div className="my-experience__wrapper">
                <div className="my-experience__column">
                    <h3 className="title title_fz20 my-experience__column-title">Образование</h3>
                    <ul>
                        <li>
                ...
                <div className="my-experience__column">
                    <h3 className="title title_fz20 my-experience__column-title">Опыт работы</h3>
                    <ul>
                        <li>
                            <div className="my-experience__item">
                                <div className="my-experience__item-head">
